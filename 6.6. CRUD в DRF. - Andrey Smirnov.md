...
Содержимое `logistic/serializers.py` и сам файл [serializers.py](./assets/6_6/serializers.py):
...
Содержимое `logistic/views.py` и сам файл [views.py](./assets/6_6/views.py):
